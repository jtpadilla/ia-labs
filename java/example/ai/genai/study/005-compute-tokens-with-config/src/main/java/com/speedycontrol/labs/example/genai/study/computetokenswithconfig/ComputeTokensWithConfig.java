package com.speedycontrol.labs.example.genai.study.computetokenswithconfig;
...
/**
 * No hay systemInstruction para ComputeTokens
 */
public final class ComputeTokensWithConfig {
    ...
    public static void main(String[] args) {
        ...
        try (Client client = genAIService.createClient()) {
            ...
            // OJO !!!
            // No hay systemInstruction para ComputeTokens
            final ComputeTokensConfig config =
                    ComputeTokensConfig.builder()
                            .build();
