...
public class ToolDemo {
    ...
    static public TemperatureQueryResult query(String provincia, List<String> ciudades) throws TemperatureQueryException {
        try {
            ...
            CityListSchema cityList = QueryCities.call(chatModel, provincia);
            ...
            for (String cityName : cityList.getList()) {
                CityDataListSchema cityDataList = QueryCitiesData.call(chatModel, cityName);
            ...
            final CityDataListSchema result = Filter.call(chatModel, dataList, ciudades);
